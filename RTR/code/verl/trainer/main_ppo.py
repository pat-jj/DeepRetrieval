...
import torch
from verl.utils.reward_score import gsm8k, math, multiply, countdown, matching, literature, screening, query_augmentation
...
def _select_rm_score_fn(data_source):
    ...
    elif "query_augmentation" in data_source:
        return query_augmentation.compute_score
    else:
